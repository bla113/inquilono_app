    ...
    return Form(
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          fillColor: const Color.fromARGB(255, 151, 151, 151),
...
//       decoration: BoxDecoration(
//         color: const Color.fromARGB(255, 137, 125, 247),
...
//           decoration: BoxDecoration(
//             color: const Color.fromARGB(255, 245, 242, 242).withOpacity(0.1),
      ...
      children: [
        ...
        TextButton(
          ...
          style: TextButton.styleFrom(
            foregroundColor: const Color.fromARGB(255, 204, 17, 17),
          ),
          child: Row(
            children: [
              ElevatedButton(
                ...
                onPressed: () {
                  Navigator.of(
                    ...
                    MaterialPageRoute(builder: (context) => AlertScreeAPI()),
                  );
                },
                child: Row(
                  children: [
...
class AlertasHome extends StatelessWidget {
  const AlertasHome({super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 20),
          child: SectionTitle(title: "Alertas", press: () {}),
        ),
        Padding(
                ...
                onPress: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder:
                          (context) => CreateAlertScreen(
                            icon: personinWindowIcon,
                            titulo: 'Intrución a Vivienda',
                          ),
                    ),
                  );
                },
                ...
                onPress: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder:
                          (context) => CreateAlertScreen(
                            icon: alteracionOrdenIcon,
                            titulo: 'Alteración al Orden',
                          ),
                    ),
                  );
                },
